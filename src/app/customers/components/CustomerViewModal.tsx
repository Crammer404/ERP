...
import { User, Mail, Phone, Hash, MapPin, Building, Globe, MessageCircle } from "lucide-react";
...
export function CustomerViewModal({
  ...
  const formatAddress = (address: Customer['address']) => {
    ...
    return parts.length > 0 ? parts.join(', ') : 'No address details provided';
  };
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                ...
                <Badge variant="secondary">
                  {customer.branch?.name || 'No branch assigned'}
                </Badge>
              </div>
              ...
              {customer.branch && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">{customer.branch.email}</p>
                  </div>

                  <div className="space-y-1">
                    <label className="text-sm font-medium text-muted-foreground">Branch Contact</label>
                    <p className="text-sm">{customer.branch.contact_no}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              {customer.address ? (
                ...
                <p className="text-sm text-muted-foreground italic">No address information provided</p>
              )}
            </div>
          </div>
        </div>
